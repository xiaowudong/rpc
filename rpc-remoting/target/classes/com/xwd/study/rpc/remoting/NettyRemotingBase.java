package com.xwd.study.rpc.remoting;

import static com.xwd.study.rpc.common.protocal.LaopopoProtocol.REQUEST_REMOTING;
import static com.xwd.study.rpc.common.protocal.LaopopoProtocol.RESPONSE_REMOTING;
...
import com.xwd.study.rpc.remoting.model.RemotingResponse;
import com.xwd.study.rpc.remoting.model.RemotingTransporter;

/**
 * netty C/S 端的客户端提取，子类去完全netty的一些创建的事情，该抽象类则取完成使用子类创建好的channel去与远程端交互
 * @author xwd	
 * @time 2018年1月17日 下午7:54:35
 */
